...
//            assert(pos_parent.node);
        ...
        @property bool empty() const { return posBegin.opEquals(posEnd); }
        void popFront() { ++posBegin; }
        @property T front() const { assert(posBegin.node); return posBegin.node.data; }
...
//                void         skip_children()             { skip_current_children_ = true; }
                void         skip_children(bool skip=true) { skip_current_children_ = skip; }
...
//                        --(*this);
                ...
                bool opEquals(/*auto ref const*/const pre_order_iterator rhs) const {
...
+/
    ...
    class sibling_iterator : iterator_base {
      public:
        ...
        bool opEquals(/*auto ref const*/const sibling_iterator rhs) const {
          if (rhs.node == this.node) return true;
          else return false;
        }
        sibling_iterator dup() /*const*/ {
...
//      alloc_.deallocate(cur,1);
    ...
    void     erase_children(/*const ref*/ iterator_base it) {
